...
export default function DemoPage() {
  ...
  return (
    <div className="h-dvh bg-[#F9FAFC] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative w-full h-dvh md:w-[360px] md:h-[780px] md:rounded-[24px] overflow-hidden md:shadow-2xl">
