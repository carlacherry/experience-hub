...
export default function DemoPage() {
  ...
  return (
    <div className="min-h-screen bg-[#d8d8d8] flex items-center justify-center">
      <div className="flex flex-col w-full max-w-[430px] h-screen md:h-[820px] md:rounded-[2.5rem] overflow-hidden bg-[#f0f0f0] md:shadow-2xl">

        {/* Header */}
        <header className="flex items-center justify-between px-4 py-3 bg-white border-b border-[#e5e5e5] shrink-0">
          <div className="flex items-center gap-3">
            <button aria-label="Volver" className="text-black">
              <ArrowLeft size={20} />
            </button>
